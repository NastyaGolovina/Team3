...
//						
//						int productPos = myProductRequestProcessor.searchBySupplyReceiveProductByCountry(productID);
//						if (productPos != -1) {
...
//																		+ '.' + way.getChainId();
//												int pos = supplyCombinations.getCountry().searchProductByID(supplyCombinations.getProduct().getidProduct());
//												if(pos != -1) {
//													double amountProduct = supplyCombinations.getCountry().getProducts().get(productPos).getPrice() * variant.getQty();
